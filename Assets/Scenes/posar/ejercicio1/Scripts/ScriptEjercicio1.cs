...
public class ScriptEjercicio1 : MonoBehaviour
{
    ...
    private bool conseguido1 = false, conseguido2 = false, conseguido3 = false, conseguido4 = false, conseguido5 = false;
    private bool actualizado1 = false, actualizado2 = false, actualizado3 = false, actualizado4 = false, actualizado5 = false;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_1-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("1-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_1-2"))
                {

                    // Desactiva elementos de comparación
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_1-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("1-2Completado", true);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_1-3"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_1-3"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido3 && control2)
                        {
                            ...
                            animator.SetBool("1-3Completado", true);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_1-4"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_1-4"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido4 && control2)
                        {
                            ...
                            animator.SetBool("1-4Completado", true);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_1-5"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_1-5"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido5 && control2)
                        {
                            ...
                            startTime = Time.time;
                            elapsedTime = Time.time - startTime;
                            animator.SetBool("1-5Completado", true);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_1-6"))
                {
                    ...
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<ClockManager>().enabled = false;
                    GameObject.Find("Canvas/RelojAguante").GetComponent<ClockManager>().enabled = false;
                    GameObject.Find("Canvas/BarraProgreso").GetComponent<BarraManager>().enabled = false;
