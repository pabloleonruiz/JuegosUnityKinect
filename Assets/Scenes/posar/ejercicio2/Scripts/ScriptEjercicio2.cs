...
public class ScriptEjercicio2 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_2-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("2-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_2-2"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_2-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("2-2Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_2-3"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_2-3"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido3 && control2)
                        {
                            ...
                            animator.SetBool("2-3Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_2-4"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_2-4"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido4 && control2)
                        {
                            ...
                            animator.SetBool("2-4Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_2-5"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_2-5"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido5 && control2)
                        {
                            ...
                            animator.SetBool("2-5Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_2-6"))
                {
                    GameObject.Find("Canvas/RelojAguante").GetComponent<Image>().fillAmount = 1;
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<Image>().fillAmount = 1;
