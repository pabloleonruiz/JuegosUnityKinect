...
public class ScriptEjercicio3 : MonoBehaviour {
    ...
    private bool conseguido1 = false, conseguido2 = false, conseguido3 = false, conseguido4 = false, conseguido5 = false, conseguido6 = false;
    private bool actualizado1 = false, actualizado2 = false, actualizado3 = false, actualizado4 = false, actualizado5 = false, actualizado6=false;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("3-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-2"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("3-2Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-3"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-3"))
                {
                    ...
                    {
                        // Cumple el porcentaje para conseguir la pose 
                        if (porcentaje <= GameManager.percent && !conseguido3 && control)
                        {
                            startTime = Time.time;
                            elapsedTime = Time.time - startTime;
                        ...
                        // Mantener la postura un tiempo (waitTime)
                        if (elapsedTime >= waitTime && conseguido3 && control2)
                        {
                            control2 = false;
                            mensajes.text = "¡Perfecto!";
                            GetComponent<AudioSource>().clip = acierto;
                            ...
                            animator.SetBool("3-3Completado", true);

                        }

                        // No se ha logrado hacer la pose en el tiempo elegido (movetime)
                        if (elapsedTime >= moveTime && !conseguido3 && control3)
                        {
                            control3 = false;
                            if (puntuado)
                            {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-4"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-4"))
                {
                    ...
                    {
                        // Cumple el porcentaje para conseguir la pose 
                        if (porcentaje <= GameManager.percent && !conseguido4 && control)
                        {
                            startTime = Time.time;
                            elapsedTime = Time.time - startTime;
                        ...
                        // Mantener la postura un tiempo (waitTime)
                        if (elapsedTime >= waitTime && conseguido4 && control2)
                        {
                            control2 = false;
                            mensajes.text = "¡Perfecto!";
                            GetComponent<AudioSource>().clip = acierto;
                            ...
                            animator.SetBool("3-4Completado", true);
                        }

                        // No se ha logrado hacer la pose en el tiempo elegido (movetime)
                        if (elapsedTime >= moveTime && !conseguido4 && control3)
                        {
                            control3 = false;
                            if (puntuado)
                            {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-5"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-5"))
                {
                    ...
                    {
                        // Cumple el porcentaje para conseguir la pose 
                        if (porcentaje <= GameManager.percent && !conseguido5 && control)
                        {
                            startTime = Time.time;
                            elapsedTime = Time.time - startTime;
                        ...
                        // Mantener la postura un tiempo (waitTime)
                        if (elapsedTime >= waitTime && conseguido5 && control2)
                        {
                            control2 = false;
                            mensajes.text = "¡Perfecto!";
                            GetComponent<AudioSource>().clip = acierto;
                            ...
                            animator.SetBool("3-5Completado", true);
                        }

                        // No se ha logrado hacer la pose en el tiempo elegido (movetime)
                        if (elapsedTime >= moveTime && !conseguido5 && control3)
                        {
                            control3 = false;
                            if (puntuado)
                            {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-6"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_3-6"))
                {
                    ...
                    {
                        // Cumple el porcentaje para conseguir la pose 
                        if (porcentaje <= GameManager.percent && !conseguido6 && control)
                        {
                            startTime = Time.time;
                            elapsedTime = Time.time - startTime;
                        ...
                        // Mantener la postura un tiempo (waitTime)
                        if (elapsedTime >= waitTime && conseguido6 && control2)
                        {
                            control2 = false;
                            mensajes.text = "¡Perfecto!";
                            GetComponent<AudioSource>().clip = acierto;
                            ...
                            animator.SetBool("3-6Completado", true);
                        }

                        // No se ha logrado hacer la pose en el tiempo elegido (movetime)
                        if (elapsedTime >= moveTime && !conseguido6 && control3)
                        {
                            control3 = false;
                            if (puntuado)
                            {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_3-7"))
                {
                    GameObject.Find("Canvas/RelojAguante").GetComponent<Image>().fillAmount = 1;
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<Image>().fillAmount = 1;
