...
public class ScriptEjercicio4 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("4-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-2"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("4-2Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-3"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-3"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido3 && control2)
                        {
                            ...
                            animator.SetBool("4-3Completado", true);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-4"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-4"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido4 && control2)
                        {
                            ...
                            animator.SetBool("4-4Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-5"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-5"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido5 && control2)
                        {
                            ...
                            animator.SetBool("4-5Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-6"))
                {
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.HandRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ShoulderRight);
                    GameObject.Find("KinectController").GetComponent<PoseDetectorScript>().poseJoints.Remove(KinectInterop.JointType.ElbowRight);
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_4-6"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido6 && control2)
                        {
                            ...
                            animator.SetBool("4-6Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_4-7"))
                {
                    GameObject.Find("Canvas/RelojAguante").GetComponent<Image>().fillAmount = 1;
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<Image>().fillAmount = 1;
