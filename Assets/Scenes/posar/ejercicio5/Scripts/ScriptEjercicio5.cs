...
public class ScriptEjercicio5 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_5-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("5-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_5-2"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_5-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("5-2Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_5-3"))
                {
                    GameObject.Find("Canvas/RelojAguante").GetComponent<Image>().fillAmount = 1;
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<Image>().fillAmount = 1;
