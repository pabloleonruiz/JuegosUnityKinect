...
public class ScriptEjercicio8 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_8-1"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido1 && control2)
                        {
                            ...
                            animator.SetBool("8-1Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_8-2"))
                {
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Pose_8-2"))
                {
                    ...
                    else
                    {
                        ...
                        if (elapsedTime >= waitTime && conseguido2 && control2)
                        {
                            ...
                            animator.SetBool("8-2Completado", true);
                        }
                ...
                if (animator.GetCurrentAnimatorStateInfo(0).IsName("Ejercicio_8-3"))
                {
                    GameObject.Find("Canvas/RelojAguante").GetComponent<Image>().fillAmount = 1;
                    GameObject.Find("Canvas/RelojTiempo").GetComponent<Image>().fillAmount = 1;
